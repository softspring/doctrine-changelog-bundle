...
[![CI](https://img.shields.io/github/actions/workflow/status/softspring/doctrine-changelog-bundle/ci.yml?branch=5.4&style=flat-square&label=CI)](https://github.com/softspring/doctrine-changelog-bundle/actions/workflows/ci.yml)
